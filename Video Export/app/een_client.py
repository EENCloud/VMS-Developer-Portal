...
class EENClient:
    ...
    def __handle_response(
        ...
        if response.ok:
            ...
            logging.info("Auth failed. Refreshing Access Token.")
            ...
            if refresh_token:
                ...
                if refresh_response.status_code == 200:
                    ...
                    logging.error("Refresh Failed: {code} {text}".format(
    ...
    def post_event(
        ...
        logging.info(f"Data type: {data['type']}")
    ...
    # Export video clip
    # For more info see:
    # https://developer.eagleeyenetworks.com/reference/createexportjob
    def export_clip(
            self, camera_id, name,
            start, end,
        ...
        self.__api_call(endpoint, method='POST', data=data)

    # Get a list of files
    # For more info see:
    # https://developer.eagleeyenetworks.com/reference/getfile
    # https://developer.eagleeyenetworks.com/reference/getfiles
    def get_files(
            self, file_id=None,
            include="size,createTimestamp",
            directory=None, mime_type=None):
    ...
    # Initiate a download
    # For more info see:
    # https://developer.eagleeyenetworks.com/reference/downloadfile
    def download_file(self, file_id):
        endpoint = f"/files/{file_id}:download"
        response = self.__api_call(endpoint, stream=True)
