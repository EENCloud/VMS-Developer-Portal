...
// Executing #2 after logging in the user is redirected back to the server with a code parameter in the query string
app.get('/', async (req, res) => {
    ...
    if (code) {
        ...
        // If no code is provided, the server will display a link to allow the user to log in.
